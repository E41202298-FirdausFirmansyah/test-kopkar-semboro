...
<div class="card">
	...
	{!! Form::open(array('url'=>'satuan?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Satuan</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										<label for="Satuan" class=" control-label col-md-4 "> Satuan </label>
										<div class="col-md-8">
										  <input  type='text' name='satuan' id='satuan' value='{{ $row['satuan'] }}' 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("satuan/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
