...
<div class="card">
	...
	{!! Form::open(array('url'=>'rak?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Rak</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										<label for="Nama Rak" class=" control-label col-md-4 "> Nama Rak </label>
										<div class="col-md-8">
										  <input  type='text' name='nama_rak' id='nama_rak' value='{{ $row['nama_rak'] }}' 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("rak/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
